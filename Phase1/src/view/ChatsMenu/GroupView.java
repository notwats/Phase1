...
public class GroupView {
    ...
    static public void run(Group group) {
        ...
        boolean bool = true;
//if (Menu.getLoggedInUser().is in the group false bud ){
//            System.out.println("join"); yes or no ...
//       return;
//        }
...
//        ArrayList<Message> messages = DBGetter.findGroupMessagesByGroupID(group.getGroupID());
//        int counter = 0;
...
//        }
    ...
    private static void sendMessage(int inReplyTo) {
        ...
        //     DBGetter.messageCreationInGroup(message, loggedInUser.getId(), group.getGroupID(), dateOfNow, -1, inReplyTo );
        //     ArrayList<Message> messages = DBGetter.findGroupMessagesByGroupID(group.getGroupID());
    ...
    private static void sendForwardedMessage(Group group, Message message) {
        ...
        Date dateOfNow = new Date();
        //   DBGetter.messageCreationInGroup(message2, loggedInUser.getId(), group.getGroupID(), dateOfNow,  message.messageID, -1 );
